...
const searchArtisans = require("./routes/search-route");
const catArtisans = require("./routes/navbar-route");
...
app.use("/api/search", searchArtisans);
app.use("/api/nav", catArtisans);
